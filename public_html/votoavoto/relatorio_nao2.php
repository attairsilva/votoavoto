    ...
    <div id="main">
	  ...
	  <div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div>
						<H2>PROFISSIONAIS COM OS VOTOS NÃO CONTABILIZADOS</H2>
	    ...
	    $sqlp=" select id_inscricao,nome,crefito,votou,forma,id_usuario,data_horario from profissionais 
	            WHERE votou='nao' or votou IS NULL order by nome ";
	     //echo '<br>SQL: '.$sqlp;
			...
			while($dadosp=mysqli_fetch_array($qprocessos)){
				...
				if($x%2==0) { $cor="#FFFFFF"; 
							...
							$texto2=$texto2.'<tr>
						      ...
						      <td width="100%" height="1"  colspan="3">'.utf8_encode($dadosp["nome"]).' - CREFITO/'.$dadosp["crefito"].'</td>
							  </tr>';
					    ...
					    profissionais não enviaram o  voto por correspondência!</font></b></h1>
						</td>
			          </tr>			
						</table>
...
<body>
		...
		<table align="center" width="800" border="0" cellspacing="0" cellpadding="10">
					  ...
					  <tr>
						...
						'.utf8_encode("ELEIÇÕES CREFITO-10").'</B></h1>  </td>
			          </tr>
					    <tr>
...
<div align="justify">'.utf8_encode('Profissionais <b> com votos não computados</b> após conferência dos votos por correspondência.  
Relação gerada em ').date('d/m/Y').':   </div>
		...
		$texto.='		</td>
					   ...
					   <tr>
			            <td colspan="5" align="left"  style=" border: 1px solid black ">
						<b><h1>Foram '.$x.' o total de votos por correspondência que não foram computados.</h1><b>
						</td>
			          </tr>					
					</table>
					</body>
                     ...
                     <? 
                      $pagename = "relatorio_naovotantes.html";
						$fp = fopen($pagename , "w");
